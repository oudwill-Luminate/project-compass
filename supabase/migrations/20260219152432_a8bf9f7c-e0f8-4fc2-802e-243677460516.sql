...
-- Create task_exclusions table for non-overlap links
CREATE TABLE public.task_exclusions (
...
BEGIN
  ...
  WHILE array_length(queue, 1) > 0 LOOP
    ...
    LOOP
      ...
      -- Check exclusion links for the successor
      FOR excl IN
