      ...
      tasks: [
        {
          ...
          estimatedCost: 5000, actualCost: 4800, dependsOn: null,
        ...
        },
        {
          ...
          estimatedCost: 1000, actualCost: 0, dependsOn: 't3',
    ...
    },
    {
      ...
      tasks: [
        ...
        },
        {
          ...
          estimatedCost: 2000, actualCost: 0, dependsOn: 't7',
      ...
      tasks: [
        {
          ...
          estimatedCost: 25000, actualCost: 0, dependsOn: 't7',
        ...
        },
        {
          ...
          estimatedCost: 10000, actualCost: 0, dependsOn: 't9',
          flaggedAsRisk: false, riskImpact: 3, riskProbability: 2,
        },
      ],
    },
